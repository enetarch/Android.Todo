...
import static ENetArch.Todo.Presentation.TodoDetail_Activity.SET_TODO;
...
public class Report_Activity extends Activity
{
	...
	protected Report_Activity thsActivity = null;
	...
	public void cmdFind_onClick (View v)
	{
		...
		{ todoList = db.get_Todos().getAll(szFilter); }
		else
		{ 
			try 
			...
			todoList = db.get_Todos().getAll(szFilter, dStart, dStop); 
		}
